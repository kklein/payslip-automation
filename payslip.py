...
def _credentials(credentials_filename: str = "credentials.json") -> Credentials:
    creds = None
    # The file token.json stores the user's access and refresh tokens, and is
    # created automatically when the authorization flow completes for the first
    # time.
    if os.path.exists(_TOKEN_FILENAME):
        creds = Credentials.from_authorized_user_file(_TOKEN_FILENAME, SCOPES)
